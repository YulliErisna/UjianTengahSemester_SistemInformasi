...
@section('title', 'Tambah Inventaris - LabSys')
        ...
        <form method="POST" action="{{ route('inventory.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="nama_alat" name="nama_alat" value="{{ old('nama_alat') }}" required class="w-full border rounded px-3 py-2">
                ...
                <div>
                    ...
                    <input id="jumlah" name="jumlah" type="number" min="1" value="{{ old('jumlah') }}" required class="w-full border rounded px-3 py-2">
                ...
                <div>
                    ...
                    <input id="lokasi" name="lokasi" value="{{ old('lokasi') }}" class="w-full border rounded px-3 py-2">
                ...
                <div>
                    ...
                    <input id="nomor_seri" name="nomor_seri" value="{{ old('nomor_seri') }}" class="w-full border rounded px-3 py-2">
                ...
                <div>
                    ...
                    <input id="tanggal_pengadaan" name="tanggal_pengadaan" type="date" value="{{ old('tanggal_pengadaan') }}" class="w-full border rounded px-3 py-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3" class="w-full border rounded px-3 py-2">{{ old('deskripsi') }}</textarea>
